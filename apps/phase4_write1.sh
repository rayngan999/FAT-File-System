...
./fs_ref.x script disk_test.fs ./scripts/script_phase4_2.example > ref.stdout 2>ref.stderr
./fs_ref.x info disk_test.fs > ref.stdout 2>ref.stderr
./fs_ref.x ls disk_test.fs > ref.stdout 2>ref.stderr
./fs_make.x disk_test.fs 4096
./test_fs.x script disk_test.fs ./scripts/script_phase4_2.example > lib.stdout 2>lib.stderr
